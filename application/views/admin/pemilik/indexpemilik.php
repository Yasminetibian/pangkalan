              ...
              <table id="datatables" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <tbody>
                    ...
                    //$dta = $this->db->query("SELECT no_kk from penduduk where nik='$nik'")->row_array();
                    foreach ($data1 as $dt) :
                    ?>
                      <tr>
                        <td><?php echo $no++ ?></td>
                        <td><?php echo $dt['nama_pemilik'];?></td>
                        <td><?php echo $dt['alamat_pemilik'];?></td>
                        <td><?php echo $dt['no_telp_pemilik'] ?></td>
                       <!-- <td style="text-align: center;">
                          <a href="<?php echo base_url('pemilik/edit_pemilik_pemilik/' . encrypt_url($dt['id_pemilik'])) ?>">
